        ...
        <MinimalLayout brandName={brand?.name}>
            <div className="flex-1 p-6 md:p-8 h-screen-safe overflow-hidden flex flex-col">
                <div className="max-w-5xl mx-auto w-full h-full flex flex-col">
                    ...
                    <div
                        ref={containerRef}
                        className="flex-1 relative overflow-hidden flex flex-col items-center custom-scrollbar overflow-y-auto"
                    >
                        {/* Static Atmosphere */}
                        <div className="fixed top-0 right-0 w-[400px] h-[400px] bg-primary/5 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 translate-x-1/4" />
                        <div className="fixed bottom-0 left-0 w-[400px] h-[400px] bg-accent/5 rounded-full blur-[120px] pointer-events-none translate-y-1/2 -translate-x-1/4" />
